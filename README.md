...
Использовать нативное Android-приложение [wireguard-turn-android](https://github.com/kiper292/wireguard-turn-android).
- Приложение содержит встроенный прокси-сервер и автоматически настраивает туннель.
