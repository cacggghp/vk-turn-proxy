...
```bash
# Запустить клиент
GOMAXPROCS=1 GODEBUG=asyncpreemptoff=1 ./client -listen 127.0.0.1:9000 -peer <ip сервера wg>:56000 -vk-link <VK ссылка>
```
...
<details>
<summary><b>Развернуть список IP адресов (AllowedIPs)</b></summary>
...
**Альтернативный способ (через Terminal):**
...
<details>
<summary>Рабочие IP Яндекса (для справки)</summary>
